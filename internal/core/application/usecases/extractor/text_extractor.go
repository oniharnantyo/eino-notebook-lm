...
// Extract returns the text content as ExtractionResult
func (e *TextContentExtractor) Extract(ctx context.Context, source usecases.ContentSource) (*ExtractionResult, error) {
	if source.Text == "" {
