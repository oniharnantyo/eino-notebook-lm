# Capability: Agent Source Awareness

## Purpose
The Agent Source Awareness capability enables the retrieval agent to be aware of the specific source catalog provided in the system prompt. This allows the agent to make informed decisions about which sources to query and how to approach information retrieval tasks based on available source metadata.
