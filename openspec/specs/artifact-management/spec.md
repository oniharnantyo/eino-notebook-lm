...
Defines the artifact lifecycle and management system for tracking, storing, and retrieving generated artifacts (mindmaps, podcasts, slides) from source content.
