# Capability: Conversation Pagination

## Purpose
Support reverse cursor-based pagination for conversation messages to enable efficient loading of message history in chat interfaces.
