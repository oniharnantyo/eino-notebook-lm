...
The Element Transformer capability provides semantic chunking of document elements for use in retrieval-augmented generation (RAG) systems. It transforms raw document elements into coherent chunks based on document structure while preserving metadata for precise source attribution.
