...
## Purpose
The Ollama Chat capability provides local large language model (LLM) inference for chat and tool calling. It enables end-to-end local operation of the Eino Notebook agent, ensuring data privacy and reducing costs by eliminating reliance on cloud LLM APIs.
