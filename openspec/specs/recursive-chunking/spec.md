...
This capability defines how documents are split into overlapping chunks using Eino's recursive splitter, enabling better context preservation for retrieval-augmented generation (RAG) systems.
